...
router.post('/profile', uploadAvatar.single('avatar'), audit('user:profile_update', 'User'), ctrl.postUpdateProfile);
...
router.post('/reviews', uploadGallery.array('photos', 5), reviewRules, handleValidation, audit('review:create', 'Review'), ctrl.postReview);
